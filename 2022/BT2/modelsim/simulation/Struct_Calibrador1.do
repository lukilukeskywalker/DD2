...
add wave -noupdate -expand -group {dut calibrador} -expand -group calc_offset -radix decimal /calibrador_test/dut_calibrador/X_out_bias
add wave -noupdate -expand -group {dut calibrador} -expand -group calc_offset -radix decimal /calibrador_test/dut_calibrador/Y_out_bias
...
add wave -noupdate /calibrador_test/spi_test_slave/pos_X
add wave -noupdate /calibrador_test/spi_test_slave/pos_Y
add wave -noupdate /calibrador_test/spi_test_slave/nCS
add wave -noupdate /calibrador_test/spi_test_slave/SPC
add wave -noupdate /calibrador_test/spi_test_slave/SDI
add wave -noupdate /calibrador_test/spi_test_slave/SDO
add wave -noupdate /calibrador_test/spi_test_slave/estado
add wave -noupdate /calibrador_test/spi_test_slave/reg_comandos
add wave -noupdate -radix hexadecimal /calibrador_test/spi_test_slave/reg_lecturas
add wave -noupdate /calibrador_test/spi_test_slave/cnt_rd_muestras
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {321656495 ps} 0}
...
update
WaveRestoreZoom {304025658 ps} {395876632 ps}
