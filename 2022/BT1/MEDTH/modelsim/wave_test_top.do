...
add wave -noupdate -group PLL /test_top/dut/simulacion/PLL/c0
...
WaveRestoreCursors {{Cursor 5} {2290160000 ps} 0} {{Cursor 6} {14940067599 ps} 0}
...
update
WaveRestoreZoom {0 ps} {15687178500 ps}
